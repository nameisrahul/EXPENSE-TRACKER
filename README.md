...
## Designing the UI
- Step 1: Setting up the project environment such as running python-django commands for creating the project and app by specifying names which will create all the dependencies for the project requirements.
...
[Dashboard](screenshots/ui part.png)
<p align="center">
  <img src="screenshots/ui part.png" width="45%"/>
</p>
